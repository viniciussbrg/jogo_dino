...
## 5. Circuitos Implementados e Funcionamento Detalhado

### 5.1. Circuito Principal (Top-Level)
...
### 5.2. Gerador de Clock (`clock zmiana.circ`)
...
## 7. Como Executar ou Simular o Projeto
